#
# Module manifest for module 'InstallLatestModule'
#
...
GUID = '12ba563a-d460-44e7-8494-f907814a8ce2'
...
Description = 'A module to update powershell modules'
...
FunctionsToExport = @('Install-LatestModule')
